  ...
  return (
    ...
    >
      <div className="h-1/5">
        ...
        <div className="px-[14px] md:px-20 mt-3 flex flex-row justify-between items-center">
          <button
            style={{
              fontSize: "11px",
              fontWeight: "bold",
      ...
      {/* <div className="h-4/5">
        <div className="h-full min-h-full">
          ...
          >
            <div
              style={{ maxWidth: "677px", minWidth: "579px" }}
              className="flex flex-col items-center flex-none col-start-1 col-end-7 box-border h-full min-h-full min-w-full"
            >
              <EventList />
            </div>
