...
export default function EventList() {
    ...
    return (
        <div className="flex flex-col rounded-xl bg-transparent h-full w-9/12 px-8 pt-8 pb-7 overflow-auto min-h-full">
            <div className="flex rounded-2xl h-40 w-full bg-white mb-6 px-5 py-4 border-gray-200" style={{ background: "rgb(0 0 0)", borderColor: "rgb(34 34 34)", borderWidth: "1px"}}>
                <div className="flex flex-none flex-col col-start-1 col-end-8">
                    ...
                    <div className="flex flex-row items-center font-sans text-xs px-3 py-2 rounded-lg mt-5 flex-none w-32" style={{ background: "#9acd32", color: "black", padding: "6px ​10px"}}>
                ...
                <div className="flex flex-row flex-grow col-start-8 col-end-12 items-center justify-end">
                    <span style={{ background: "rgb(15 15 15)" }} className="flex items-center justify-items-center w-20 h-14 rounded-lg bg-gray-200 hover:bg-gray-100">    
                        <img className="w-10 mx-auto my-0" alt='emoji' src={`${toAbsoluteUrl("/media/images/emojis/developer.png")}`} />
                    </span>
                </div>
            </div>
            <div className="flex rounded-2xl h-40 w-full bg-white px-5 mb-6 py-4 border-2 border-gray-200" style={{ background: "rgb(0 0 0)", borderColor: "rgb(34 34 34)", borderWidth: "1px"}}>
                <div className="flex flex-col col-start-1 col-end-8">
                    ...
                    <p className="font-sans text-gray-500" style={{ color: "#6e7463"}}>1800 Blvd. Party and Drinks...</p>
                    <div className="flex flex-row items-center font-sans text-xs px-3 py-2 rounded-lg mt-5 w-32 text-gray-600" style={{ background: "#9acd32", color: "black", padding: "6px ​10px"}}>
                        <span style={{ color: "black" }} className="font-semibold text-gray-600">View details</span>
                        <ArrowNarrowRightIcon className="ml-3 w-5" />
                    </div>
                </div>
            ...
            <div className="flex rounded-2xl h-40 w-full bg-white px-5 mb-6 py-4 border-2 border-gray-200" style={{ background: "rgb(0 0 0)", borderColor: "rgb(34 34 34)", borderWidth: "1px"}}>
                <div className="flex flex-col col-start-1 col-end-8">
                    ...
                    <p className="font-sans text-gray-500" style={{ color: "#6e7463"}}>1800 Blvd. Party and Drinks...</p>
                    <div className="flex flex-row items-center font-sans text-xs px-3 py-2 rounded-lg mt-5 w-32" style={{ background: "#9acd32", color: "black", padding: "6px ​10px"}}>
                        <span style={{ color: "black" }} className="font-semibold text-gray-600">View details</span>
                        <ArrowNarrowRightIcon className="ml-3 w-5" />
                    </div>
                </div>
            ...
            <div className="flex rounded-2xl h-40 w-full bg-white px-5 mb-6 py-4 border-2 border-gray-200" style={{ background: "rgb(0 0 0)", borderColor: "rgb(34 34 34)", borderWidth: "1px"}}>
                <div className="flex flex-col col-start-1 col-end-8">
                    ...
                    <p className="font-sans text-gray-500" style={{ color: "#6e7463"}}>Wuse 2, Abuja, Nigeria</p>
                    <div className="flex flex-row items-center font-sans text-xs px-3 py-2 rounded-lg mt-5 w-32" style={{ background: "#9acd32", color: "black", padding: "6px ​10px"}}>
                        <span style={{ color: "black" }} className="font-semibold text-gray-600">View details</span>
                        <ArrowNarrowRightIcon className="ml-3 w-5" />
                    </div>
